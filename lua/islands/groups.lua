...
local function setup(configs)
   ...
   return {
      ...
      Keyword = { fg = colors.keyword_blue },
      Keywords = { fg = colors.keyword_blue },
      Identifier = { fg = colors.white },
      Function = { fg = colors.cyan },
      Statement = { fg = colors.keyword_blue },
      Conditional = { fg = colors.keyword_blue },
      Repeat = { fg = colors.keyword_blue },
      Label = { fg = colors.cyan },
      Exception = { fg = colors.keyword_blue },
      PreProc = { fg = colors.yellow },
      Include = { fg = colors.keyword_blue },
      Define = { fg = colors.keyword_blue },
      Title = { fg = colors.cyan },
      Macro = { fg = colors.keyword_blue },
      PreCondit = { fg = colors.cyan },
      Type = { fg = colors.purple },
      StorageClass = { fg = colors.keyword_blue },
      ...
      Cursor = { reverse = true },
      CursorLineNr = { fg = colors.gutter_fg, bold = true },
      ...
      IncSearch = { fg = colors.white, bg = colors.comment },
      ...
      ["@variable.parameter.reference"] = { fg = colors.white },
      ["@function.method"] = { fg = colors.cyan },
      ["@variable.member"] = { fg = colors.type_cyan },
      ["@property"] = { fg = colors.type_cyan },
      ["@constructor"] = { fg = colors.purple },

      ["@keyword.conditional"] = { fg = colors.keyword_blue },
      ["@keyword.repeat"] = { fg = colors.keyword_blue },
      ["@label"] = { fg = colors.cyan },

      ["@keyword"] = { fg = colors.keyword_blue },
      ["@keyword.function"] = { fg = colors.keyword_blue },
      ["@keyword.function.ruby"] = { fg = colors.keyword_blue },
      ["@keyword.operator"] = { fg = colors.keyword_blue },
      ["@operator"] = { fg = colors.keyword_blue },
      ["@keyword.exception"] = { fg = colors.keyword_blue },
      ["@type"] = { fg = colors.purple },
      ["@type.builtin"] = { fg = colors.purple, italic = true },
      ["@type.qualifier"] = { fg = colors.keyword_blue },
      ["@structure"] = { fg = colors.purple },
      ["@keyword.include"] = { fg = colors.keyword_blue },
      ...
      ["@struct"] = { fg = colors.purple },
      ["@enum"] = { fg = colors.purple },
      ["@enumMember"] = { fg = colors.type_cyan },
      ["@event"] = { fg = colors.type_cyan },
      ["@interface"] = { fg = colors.purple },
      ["@modifier"] = { fg = colors.keyword_blue },
      ["@regexp"] = { fg = colors.yellow },
      ["@typeParameter"] = { fg = colors.purple },
